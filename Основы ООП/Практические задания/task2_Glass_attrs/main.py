...
if __name__ == "__main__":
    ...
    glass2 = Glass(200, 50)  #  инициализировать ещё один стакан
    print(glass2.capacity_volume, glass2.occupied_volume)  #  распечатать атрибуты экземпляра glass2

    print("Доливаем воды в первый стакан 100 мл")
    glass1.occupied_volume += 100    #   доливаем воды в первый стакан
    print(glass1.capacity_volume, glass1.occupied_volume)
    print(glass2.capacity_volume, glass2.occupied_volume)

    print(glass1 is glass2)    #   сравнить id объектов
